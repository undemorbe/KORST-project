                ...
                children: [
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(l10n.themeTitle, style: Theme.of(context).textTheme.bodyLarge),
                        Observer(
                  ...
                  Padding(
                    ...
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(l10n.languageTitle, style: Theme.of(context).textTheme.bodyLarge),
                        Observer(
                          builder: (_) => DropdownButton<Locale>(
                            ...
                            items: [
                              ...
                              DropdownMenuItem(value: Locale('ru'), child: Text(AppLocalizations.of(context)!.russianLanguage)),
                              const DropdownMenuItem(value: Locale('es'), child: Text('Español')),
